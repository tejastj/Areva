...
public class SharmaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRef = new Firebase("https://myfirebaseauthapp-ae0c6.firebaseio.com/NYzRl8AaoZRPdZnr3GbbPztgFgI2/Sharma/latitude");
        ...
        nRef = new Firebase("https://myfirebaseauthapp-ae0c6.firebaseio.com/NYzRl8AaoZRPdZnr3GbbPztgFgI2/Sharma/longitude");
        ...
        pRef = new Firebase("https://myfirebaseauthapp-ae0c6.firebaseio.com/NYzRl8AaoZRPdZnr3GbbPztgFgI2/Sharma/place");
        ...
        inMaps.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SharmaActivity.this ,SharmaMapsActivity.class);
