...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRef = new Firebase("https://myfirebaseauthapp-ae0c6.firebaseio.com/NYzRl8AaoZRPdZnr3GbbPztgFgI2/Chethan/latitude");
        ...
        nRef = new Firebase("https://myfirebaseauthapp-ae0c6.firebaseio.com/NYzRl8AaoZRPdZnr3GbbPztgFgI2/Chethan/longitude");
        ...
        pRef = new Firebase("https://myfirebaseauthapp-ae0c6.firebaseio.com/NYzRl8AaoZRPdZnr3GbbPztgFgI2/Chethan/place");
        ...
        inMaps.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this ,ChethanMapsActivity.class);
