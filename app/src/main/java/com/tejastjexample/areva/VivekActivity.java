...
public class VivekActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRef = new Firebase("https://myfirebaseauthapp-ae0c6.firebaseio.com/NYzRl8AaoZRPdZnr3GbbPztgFgI2/Vivek/latitude");
        ...
        nRef = new Firebase("https://myfirebaseauthapp-ae0c6.firebaseio.com/NYzRl8AaoZRPdZnr3GbbPztgFgI2/Vivek/longitude");
        ...
        pRef = new Firebase("https://myfirebaseauthapp-ae0c6.firebaseio.com/NYzRl8AaoZRPdZnr3GbbPztgFgI2/Vivek/place");
        ...
        inMaps.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(VivekActivity.this ,VivekMapsActivity.class);
